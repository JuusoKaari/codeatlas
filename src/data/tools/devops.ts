...
,
    {
        ...
        first_release_date: '2012-02-20',
        programming_language: 'Python',
        dependencies: [],
        alternatives: ['Puppet', 'Chef', 'SaltStack'],
        popularity_score: 86,
        links: ['jenkins', 'vagrant'],
    },
    {
        id: 'jenkins',
        name: 'Jenkins',
        ...
        description: 'Open-source automation server for building, deploying, and automating software projects.',
        website: 'https://www.jenkins.io',
        license: 'MIT',
        created_by: 'Kohsuke Kawaguchi',
        first_release_date: '2011-02-05',
        programming_language: 'Java',
        dependencies: [],
        alternatives: ['Travis CI', 'CircleCI', 'GitLab CI/CD'],
        popularity_score: 90,
        links: ['ansible', 'docker'],
    },
    {
        id: 'prometheus',
        name: 'Prometheus',
        ...
        description: 'Open-source monitoring and alerting system for cloud-native applications.',
        website: 'https://prometheus.io',
        license: 'Apache-2.0',
        created_by: 'SoundCloud',
        first_release_date: '2015-11-24',
        programming_language: 'Go',
        dependencies: [],
        alternatives: ['Nagios', 'Zabbix', 'Graphite'],
        popularity_score: 87,
        links: ['grafana', 'alertmanager'],
    }]; 